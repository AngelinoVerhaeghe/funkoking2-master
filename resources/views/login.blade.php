...
@section('content')
    <section id="mid-content" class="row">
        <div class="col-lg-4">
            <img id="picture-right" class="img-fluid d-none d-lg-block" src="{{ asset('images/side-left-login.png') }}"
                alt="side-picture">
        </div>
        <div class="col-lg-4">
        ...
        <div class="col-lg-4">
            <img id="picture-left" class="img-fluid d-none d-lg-block" src="{{ asset('images/side-right-login.png') }}"
                alt="side-picture">
        </div>
    </section>
@endsection
