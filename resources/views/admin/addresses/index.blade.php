...
@section('content')
                                ...
                                <td class="d-flex align-items-center justify-content-around">
                                    <div>
                                        <button class="btn btn-xs bg-primary text-white p-1 px-2 shadow"
                                            ...
                                            data-address_id="{{ $address->id }}" data-toggle="modal"
                                            data-target="#editAddress">Edit</button>
                                    </div>

                                    @if ($address->deleted_at != null)
                                        <a class="btn btn-xs bg-danger text-white p-1 px-2 shadow"
                                            href="{{ route('admin.addressrestore', $address->id) }}">Not Active</a>
                                    @else
    ...
    <!-- Modal Edit Address-->
    <div class="modal fade" id="editAddress" tabindex="-1" role="dialog" aria-labelledby="editAddressCenterTitle"
        aria-hidden="true">
